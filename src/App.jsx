...
function App() {
  ...
  return (
    <Main>
          ...
          <div onClick={e => e.stopPropagation()}>
            {success ? (
              ...
              <StyledForm
                ...
                animate={{ opacity: 1, scale: 1 }}
              >
                <Title style={{ fontSize: "1.6rem", marginBottom: 0 }}>Регистрация</Title>
                <input
                  required
                  placeholder="ФИО"
                  value={form.fio}
      ...
      {/* Блок входа в админку */}
      {!adminMode ? (
        <AdminPanel>
          <b>Вход для организаторов</b>
          <form onSubmit={handleAdminLogin} style={{ marginTop: 16, display: "flex", alignItems: "center" }}>
            <AdminInput
              type="password"
              placeholder="Пароль"
              value={adminPw}
